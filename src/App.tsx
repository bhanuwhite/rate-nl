...
function App() {
  return (
    <>
      <div className='bg-[#63C9EB] h-[10px] w-full fixed top-0 '>
      </div>
      <div className='main_body bg-[#F6FCFE]'>
        ...
        <div className='card section flex max-w-[1200px] bg-[#fff] rounded-lg mx-auto border border-blue-200 mt-5'>
        ...
        <footer className='fixed bottom-0 w-full '>
          <div className='flex justify-between items-center bg-[#D3F0FA] h-[40px] px-[60px]'>
