...
function CardLastPage() {
    return (
        <>
            <div className='card  flex max-w-[1200px] bg-[#fff] rounded-lg mx-auto border border-blue-200' style={{ borderRadius: '15px' }}>
                ...
                <div className='w-[65%]'>
                    <div className='max-w-[600px] mx-auto flex h-full flex-col justify-center'>
                        ...
                        <h1 className='text-[32px] font-medium  text-left'>Thanks you for your time!</h1>
                        </div>
                        ...
                        <div className='py-4'>
                            <div className='flex items-center gap-[20px] mt-3'>
                                ...
                                <div>
                                    <h3 className='text-[17px]  font-medium'>Download your survey as a pdf</h3>
                            ...
                            <div className='flex items-center gap-[20px] mt-3'>
                                ...
                                <div>
                                    <h3 className='text-[17px] text-[#000] font-medium'>Share your survey</h3>
                                    <p className='text-[12px] text-[#00303C]'>Copy the link bellow to share your survey results</p>
                                    <div className='flex items-center gap-3 justify-center'>
                                    <div className="h-40px w-[210px] rounded-lg border border-[#7C8388] flex items-center  p-5 py-1 mt-3">
                                    <a
                                        href="#"
                                        className="text-[12px] border-b-2 text-[#3498DB]"
                                    >
                                       www.rate.nl/srvy/12368314YCZ
                                    </a>
                                </div>
                                <div className='icons mt-3 '>
                                    <GrAttachment className='h-[17px] w-[17px]' style={{ color: '#fff' }} />
                                </div>
                                </div>
                                </div>
                             ...
                             <div className='flex items-center gap-[20px] mt-3'>
                                ...
                                <div>
                                    <h3 className='text-[17px] text-[#000] font-medium'>E-mail your survey</h3>
