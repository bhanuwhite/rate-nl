...
const  FeedBackCards: React.FC<ChatInputProps>=({ onEditIconClick }) => {
    return (
        ...
        <div className='max-w-[1200px] justify-start mx-auto'>
            ...
            <div >
                    <img src="/images/Vess_robot_icon.png" className="w-[500px]" alt="" />
                </div>
            <div className=' mx-auto flex'>
                <a href="#" className="block  p-6 border  rounded-lg shadow bg-[#ECF8FD] ">
                ...
                <div>
                <img src="/images/Record_button.png" className="w-[200px] " alt="" />
                </div>
                </div>
            </div>
            </div>
